          ...
          {showEmail && (
            ...
            >
              ...
              <motion.button
                type="submit"
                disabled={loading}
                className="w-full bg-[#1E2328] text-white py-3.5 rounded-xl font-semibold hover:bg-[#2B3136] active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 border border-white/10"
                whileTap={{ scale: 0.98 }}
              >
